...
# Support both development layout and PyInstaller frozen layout
def _find_frontend_dist() -> Path:
    """Find frontend dist directory (works in dev and frozen exe)."""
    import sys
    # Frozen exe: resources bundled next to the exe
    if getattr(sys, 'frozen', False):
        base = Path(sys.executable).parent
        return base / "frontend_dist"
    # Development: standard layout
